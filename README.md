...
### Installation
* `npm install "github:ublitzjs/uwsjs-fork#v0.0.2"`
* `bun install "github:ublitzjs/uwsjs-fork#v0.0.2" && bun pm trust uwsjs-fork` or use "trustedDependencies" in package.json
